...
public class OfficeServiceImpl implements OfficeService {
	...
	public OfficeIdViewResp loadById(String id) {
		...
		Office office = officeDao.findById(Long.parseLong(id));
		...
		OfficeIdViewResp viewResp = new OfficeIdViewResp(String.valueOf(office.getId()), office.getName(),
				office.getAddress(), office.getPhone(), String.valueOf(office.getIsActive()));
	...
	public List<OfficeListViewResp> loadByOrg(OfficeListViewReq reqView) {
		...
		Organization org = orgDao.findById(Long.parseLong(reqView.orgId));
	...
	public SuccessView save(OfficeSaveViewReq reqView) {
		...
		String saveValErrors = joiner.join(Strings.emptyToNull(officeVal.valId(reqView.orgId, true)),
	...
	public SuccessView update(OfficeUpdateViewReq reqView) {
		...
		Office office = officeDao.findById(Long.parseLong(reqView.id));
