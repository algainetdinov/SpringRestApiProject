...
public class OrganizationServiceImpl implements OrganizationService {
	...
	public OrganizationIdViewResp loadById(String id) {
		...
		OrganizationIdViewResp viewResp = new OrganizationIdViewResp(String.valueOf(org.getId()), org.getName(),
				org.getFullName(), org.getInn(), org.getKpp(), org.getAddress(), org.getPhone(),
				String.valueOf(org.getIsActive()));
	...
	public List<OrganizationListViewResp> loadByName(OrganizationListViewReq reqView) {
		...
		String loadByNameValErrors = joiner.join(Strings.emptyToNull(orgVal.valName(reqView.name, true)),
	...
	public SuccessView save(OrganizationSaveViewReq reqView) {
		...
		String saveValErrors = joiner.join(Strings.emptyToNull(orgVal.valName(reqView.name, true)),
	...
	public SuccessView update(OrganizationUpdateViewReq reqView) {
		...
		String updateValErrors = joiner.join(Strings.emptyToNull(orgVal.valId(reqView.id, true)),
