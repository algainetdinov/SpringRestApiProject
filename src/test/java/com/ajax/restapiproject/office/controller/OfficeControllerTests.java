...
public class OfficeControllerTests {
	...
	public void getByIdTest() throws Exception {
		...
		RequestBuilder request = MockMvcRequestBuilders.get("/api/office/1").accept(MediaType.APPLICATION_JSON);
	...
	public void getByOrgTest() throws Exception {
		...
		RequestBuilder request = MockMvcRequestBuilders.post("/api/office/list").contentType(MediaType.APPLICATION_JSON)
				.content("{\"orgId\":\"1\"}");
	...
	public void updateTest() throws Exception {
		...
		RequestBuilder request = MockMvcRequestBuilders.post("/api/office/update")
	...
	public void saveTest() throws Exception {
		...
		RequestBuilder request = MockMvcRequestBuilders.post("/api/office/save").contentType(MediaType.APPLICATION_JSON)
				.content("{\"name\":\"Ajax\"}");
	...
	public void deleteByIdTest() throws Exception {
		...
		RequestBuilder request = MockMvcRequestBuilders.get("/api/office/delete/1")
