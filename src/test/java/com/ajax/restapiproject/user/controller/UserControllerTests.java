...
public class UserControllerTests {
	...
	public void getByIdTest() throws Exception {
		...
		RequestBuilder request = MockMvcRequestBuilders.get("/api/user/1").accept(MediaType.APPLICATION_JSON);

		UserIdViewResp viewResp = new UserIdViewResp("1", "James", "Brown", "Tom", "worker", "1", "1234", "01",
				"Passport", "11 11", "11.12.2015", "Russia", "02", "true");

		when(userService.loadById(anyString())).thenReturn(viewResp);

		mvc.perform(request).andExpect(status().isOk()).andExpect(content()
				.json("{\"data\":{\"id\":\"1\",\"firstName\":\"James\",\"lastName\":\"Brown\",\"middleName\":\"Tom\""
	...
	public void getByOfficeTest() throws Exception {
		...
		RequestBuilder request = MockMvcRequestBuilders.post("/api/user/list").contentType(MediaType.APPLICATION_JSON)
				.content("{\"officeId\":\"1\"}");
	...
	public void updateTest() throws Exception {
		...
		RequestBuilder request = MockMvcRequestBuilders.post("/api/user/update").contentType(MediaType.APPLICATION_JSON)
				.content("{\"id\":\"1\"}");
	...
	public void saveTest() throws Exception {
		...
		RequestBuilder request = MockMvcRequestBuilders.post("/api/user/save").contentType(MediaType.APPLICATION_JSON)
	...
	public void deleteByIdTest() throws Exception {
		...
		RequestBuilder request = MockMvcRequestBuilders.get("/api/user/delete/1")
